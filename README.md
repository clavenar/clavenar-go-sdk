...
```bash
go get github.com/clavenar/clavenar-go-sdk@v1.5.0
```
...
```bash
go get github.com/clavenar/clavenar-go-sdk/adapters/anthropic@v1.5.0
go get github.com/clavenar/clavenar-go-sdk/adapters/openai@v1.5.0
```
